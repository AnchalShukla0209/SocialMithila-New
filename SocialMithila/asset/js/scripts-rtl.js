$(document).ready(function() {
    ...
    $('.product-slider').owlCarousel({
        ...
        responsive: {
            0: { items: 1 },
            600: { items: 1 },
            1200: { items: 1 } // always 1 per slide
        }
    });
